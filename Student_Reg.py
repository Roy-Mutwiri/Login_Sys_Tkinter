...
Button(root, text="Save", width=19, height=2, font="arial 12 bold", bg="lightblue")
saveButton.place(x=1000, y=370)
Button(root, text="Reset", width=19, height=2, font="arial 12 bold", bg="lightblue").place(x=1000, y=370)
